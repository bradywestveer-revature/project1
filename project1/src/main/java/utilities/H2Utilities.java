...
public class H2Utilities {
	...
	public static void createUsersTable () {
		executeStatement ("CREATE TABLE ERS_USERS (ERS_USERS_ID serial PRIMARY KEY NOT NULL, ERS_USERNAME VARCHAR (50) UNIQUE NOT NULL, ERS_PASSWORD VARCHAR (60) NOT NULL, USER_FIRST_NAME VARCHAR (100) NOT NULL, USER_LAST_NAME VARCHAR (100) NOT NULL, USER_EMAIL VARCHAR (150) UNIQUE NOT NULL, USER_ROLE_ID int NOT NULL REFERENCES ERS_USER_ROLES (ERS_USER_ROLE_ID));");
		
		executeStatement ("INSERT INTO ERS_USERS (ERS_USERNAME, ERS_PASSWORD, USER_FIRST_NAME, USER_LAST_NAME, USER_EMAIL, USER_ROLE_ID) VALUES ('manager1', '$2a$12$t3usDyOnl7oQtYOABIyhc.Cz.BxVFD7gWvcIDbeFgw8jd2vYw4dDS', 'Manager', 'One', 'managerone@gmail.com', 2);");
		executeStatement ("INSERT INTO ERS_USERS (ERS_USERNAME, ERS_PASSWORD, USER_FIRST_NAME, USER_LAST_NAME, USER_EMAIL, USER_ROLE_ID) VALUES ('employee1', '$2a$12$qxW7yx45Zb8OMpQTCWGfmuf8VnIxtO3mRAS9ozJpyAfWDJNg0jjbS', 'Employee', 'One', 'employeeone@gmail.com', 1);");
		executeStatement ("INSERT INTO ERS_USERS (ERS_USERNAME, ERS_PASSWORD, USER_FIRST_NAME, USER_LAST_NAME, USER_EMAIL, USER_ROLE_ID) VALUES ('employee2', '$2a$12$qxW7yx45Zb8OMpQTCWGfmuf8VnIxtO3mRAS9ozJpyAfWDJNg0jjbS', 'Employee', 'Two', 'employeetwo@gmail.com', 1);");
		executeStatement ("INSERT INTO ERS_USERS (ERS_USERNAME, ERS_PASSWORD, USER_FIRST_NAME, USER_LAST_NAME, USER_EMAIL, USER_ROLE_ID) VALUES ('employee3', '$2a$12$qxW7yx45Zb8OMpQTCWGfmuf8VnIxtO3mRAS9ozJpyAfWDJNg0jjbS', 'Employee', 'Three', 'employeethree@gmail.com', 1);");
	}
